...
/**
 * LintCode 239.Root of Equation
 * Link: https://www.lintcode.com/problem/239/
 *
 ...
 *      Input: a = 1, b = -3, c = 2
 *      Output: [1,2]
 *      Explanation: The equation has two roots, returning [1,2] and the first
 *                   number should be smaller than the second.
 *
 */
